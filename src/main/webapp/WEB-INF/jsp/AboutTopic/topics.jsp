...
<body>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="jumbotron" align="center">
					<h4 >全部话题</h4>
					<p>
						<a href="${pageContext.request.contextPath}/topicCenter" class="btn btn-primary btn-lg" role="button">
							进入话题广场
						</a>
					</p>
				</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/frontResource/JS/Topic/Topics.js"></script>
