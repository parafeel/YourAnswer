...
<body>
	...
	<br>
	<br>
		<form method="post" action="${pageContext.request.contextPath}/updateAnswer/${currentAnswer.aId}">
			<div class="highlight form-group">
				...
				<div class="QuestionButtonGroup" style = "text-align:left;">
					...
					<button type="submit" class="btn btn-default" id="addAnswerBtn">修改回答</button>
					<div>
						<span class="text-left text-danger">${updateAnswerMessage}</span>
					</div>
				</div>
			</div>
		</form>
